    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-10"
        ...
        <div className="w-full max-w-sm">
          ...
          {/* Google */}
          <button className="btn-google w-full rounded-lg py-2.5 text-sm font-medium text-gray-700 flex items-center justify-center gap-2.5 border border-gray-200 bg-white transition-colors"
            style={{ cursor: "pointer", fontFamily: "'Inter', sans-serif" }}>
            <svg width="16" height="16" viewBox="0 0 48 48">
              <path fill="#EA4335" d="M24 9.5c3.2 0 5.9 1.1 8.1 2.9l6-6C34.5 3.1 29.6 1 24 1 14.8 1 7 6.7 3.7 14.7l7 5.4C12.4 13.6 17.7 9.5 24 9.5z"/>
              <path fill="#4285F4" d="M46.5 24.5c0-1.6-.1-3.1-.4-4.5H24v8.5h12.7c-.6 3-2.3 5.5-4.8 7.2l7.4 5.7C43.4 37.4 46.5 31.4 46.5 24.5z"/>
              ...
              <path fill="#34A853" d="M24 47c5.5 0 10.2-1.8 13.6-4.9l-7.4-5.7c-1.8 1.2-4.1 1.9-6.2 1.9-6.3 0-11.6-4.2-13.4-9.9l-7.4 6.1C7 42.3 14.9 47 24 47z"/>
            </svg>
            Sign up with Google
          </button>
          ...
          <p className="mt-4 text-center text-xs text-gray-400 leading-relaxed">
            ...
            <a href="#" className="text-gray-600 link">Terms</a> and{" "}
            <a href="#" className="text-gray-600 link">Privacy Policy</a>.
          </p>

          {/* Sign in */}
          <p className="mt-5 text-center text-xs text-gray-400">
            Already have an account?{" "}
            <a href="/login" className="text-gray-900 font-medium link">Sign in</a>
          </p>
